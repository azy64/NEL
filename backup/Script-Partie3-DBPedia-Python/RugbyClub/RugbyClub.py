...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 20 16:50:36 2020
...
query="""select  ?f ?e
where {?f a <http://dbpedia.org/ontology/RugbyClub>.
?f rdfs:label ?e
...
for result in results["results"]["bindings"]:
    ...
    data_dict={'lien':result["f"]["value"],'RugbyClub':result["e"]["value"]}
